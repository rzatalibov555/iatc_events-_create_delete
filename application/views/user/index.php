                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content p-relative z-index-1">
                           <h3 class="hero__title">
                              ...
                              <span class="yellow-shape">Online <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg.png" alt="yellow-shape"> </span>
                              Tutorial From Top Instructor.</h3>
                              <p>Meet university,and cultural institutions, who'll share their experience.</p>
                              <a href="<?php echo base_url('courses'); ?>" class="e-btn">Bütün kurslar</a>
                        </div>
                     </div>
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__thumb d-flex p-relative">
                           ...
                           <div class="hero__thumb-big mr-30">
                              <img src="<?php echo base_url('assets/user/'); ?>assets/img/hero/hero-1.jpg" alt="">
                           ...
                           <div class="hero__thumb-sm mt-50 d-none d-lg-block">
                              <img src="<?php echo base_url('assets/user/'); ?>assets/img/hero/hero-sm-1.jpg" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row align-items-end">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                     <div class="section__title-wrapper mb-45">
                        <h2 class="section__title"><span class="yellow-bg">Məşhur <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt="">  </span>kateqoriyalar
                        </h2>
                     </div>
                  </div>
               ...
               <div class="row align-items-end">
                  <div class="col-xxl-12 col-xl-12 col-lg-12">
                     <div class="section__title-wrapper mb-60">
                         <h2 class="section__title"><span class="yellow-bg">Məşhur <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt="">  </span>Kurslarımız
                         </h2>
                     </div>
                  </div>
...
<!--                           <button data-filter=".cat4">Art & Design</button>-->
               ...
               <div class="row grid">
                    <?php foreach ($all_courses as $all_courses_key) { ?>
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat<?php echo $all_courses_key['i_c_id']; ?>">
                            <div class="course__item white-bg mb-30 fix">
                                <div class="course__thumb w-img p-relative fix">

                                    <a href="<?php echo base_url('course_single/'.$all_courses_key['c_id']); ?>">
                                        <img height="220px" style="object-fit: cover;" src="<?php echo base_url('upload/courses/'.$all_courses_key['img']); ?>" alt="">
                                    </a>
