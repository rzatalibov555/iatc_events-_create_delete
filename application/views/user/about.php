                  ...
                  <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                     <div class="about__thumb-wrapper">
                        ...
                        <div class="about__thumb ml-100">
                           <img src="<?php echo base_url('assets/user/') ?>assets/img/about/about.jpg" alt="">
                        </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content pl-70 pr-60 pt-25">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title">Achieve your <br><span class="yellow-bg-big">Goals <img src="<?php echo base_url('assets/user/') ?>assets/img/shape/yellow-bg-2.png" alt=""></span>  with Educal </h2>
